...
const ZenHero = React.forwardRef<HTMLElement, HeroProps>(
  (
    {
      className,
      gradient = true,
      ...
      >
        ...
        >
          <div className="flex flex-col items-center text-center space-y-4">
            <h1
              className={cn(
                "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-normal tracking-tight",
                titleClassName,
              )}
            >
              {title}
